...
[OutputSchema](https://esqlabs.github.io/osp.snapshots/reference/OutputSchema.md)'s
`Intervals` array. Each interval carries optional name and the three
[Parameter](https://esqlabs.github.io/osp.snapshots/reference/Parameter.md)s
