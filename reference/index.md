...
- [`Range-class`](https://esqlabs.github.io/osp.snapshots/reference/Range-class.md)
...
- [`create_event()`](https://esqlabs.github.io/osp.snapshots/reference/create_event.md)
  : Create a new event
- [`create_event_selection()`](https://esqlabs.github.io/osp.snapshots/reference/create_event_selection.md)
...
- [`create_observer_set_selection()`](https://esqlabs.github.io/osp.snapshots/reference/create_observer_set_selection.md)
...
- [`add_event()`](https://esqlabs.github.io/osp.snapshots/reference/add_event.md)
...
- [`add_observer_set()`](https://esqlabs.github.io/osp.snapshots/reference/add_observer_set.md)
  : Add one or more observer sets to a snapshot
- [`add_population()`](https://esqlabs.github.io/osp.snapshots/reference/add_population.md)
...
- [`remove_protocol()`](https://esqlabs.github.io/osp.snapshots/reference/remove_protocol.md)
  : Remove protocols from a snapshot
- [`remove_simulation()`](https://esqlabs.github.io/osp.snapshots/reference/remove_simulation.md)
...
- [`get_observer_sets_dfs()`](https://esqlabs.github.io/osp.snapshots/reference/get_observer_sets_dfs.md)
