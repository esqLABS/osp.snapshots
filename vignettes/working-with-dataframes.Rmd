...
# Parameters
head(individual_dfs$parameters)

# Expression profiles
head(individual_dfs$expression_profiles)
```
...
# Examine compound data structure
table(compounds_df$category)
table(compounds_df$type)
```
