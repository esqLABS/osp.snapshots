...
Install the released version of osp.snapshots from the R-universe. osp.snapshots is served by the [esqLABS universe](https://esqlabs.r-universe.dev) and its `ospsuite` dependency by the [Open Systems Pharmacology universe](https://open-systems-pharmacology.r-universe.dev), so list both:
