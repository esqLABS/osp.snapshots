...
osp.snapshots comes from the [esqLABS universe](https://esqlabs.r-universe.dev) and its `ospsuite` dependency from the [Open Systems Pharmacology universe](https://open-systems-pharmacology.r-universe.dev), so both go on `repos`.
